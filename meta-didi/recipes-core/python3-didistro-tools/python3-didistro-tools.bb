...
do_deploy() {
    ...
    install -m 0666 ${WORKDIR}/current_side ${DEPLOYDIR}/didistro
    install -m 0666 ${WORKDIR}/next_boot_side ${DEPLOYDIR}/didistro
    install -m 0666 ${WORKDIR}/reboot_counter ${DEPLOYDIR}/didistro
}
